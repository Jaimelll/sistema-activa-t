...
-- FORCE FIX: Drop everything and recreate with INTEGER IDs
BEGIN;

-- 1. Drop Tables with CASCADE to remove all dependencies
...
-- 2. Create Proyectos with INTEGER ID
...
-- 3. Create Becas with INTEGER ID
